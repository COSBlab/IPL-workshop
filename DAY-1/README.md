...
* prepare an alignment file in MODELLER format with the sequences of the chains to model. This file is constructed from the alignment obtained with MAFFT a few modifications:
